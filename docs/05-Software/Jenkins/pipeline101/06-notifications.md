...
`image/1564463655933.png` (이미지 파일 누락으로 생략)
...
5. 등록된 Item을 확인하고 해당 빌드를 Jenkins 콘솔에서 실행해봅니다. 결과에 대한 알림이 발생하는 것을 확인 할 수 있습니다.
   ...
   `image/1564464197547.png` (이미지 파일 누락으로 생략)
...
`image/1564464880533.png` (이미지 파일 누락으로 생략)
...
`image/1564465713857.png` (이미지 파일 누락으로 생략)
