...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-c0b17d02-ED46Z4WG.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-d6f8fe3a-QPA3CDQA.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-58f49b84-YWY3GK64.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-dedf2781-BMLAZGNN.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-e0ffc2d1-I4NRI3CO.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-088dbd90-OSTGVITF.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-64895a6e-UYROTAIV.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-3fca7ce7-UFQ3Z2OB.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-0ca4be02-EEQ74AJ5.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-e13af0f0-IV7CGP3Y.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-84aa38e3-XZ4G7HGI.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-a8cc8886-KSDXLHO4.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-802a48d3-JKD2OWO4.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-9a586ac6-7VB6PQJP.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-96f2b9df-TAATBNBB.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-adaa34f8-LESZFD35.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-56584a6c-4NWOYSZ3.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-1a90b03d-GSB5CTFY.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-57868176-AJRTSMHY.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-a7f8e230-ZSRFUBQ5.js");
...
var handleDirective = function(p, directive, type22) {
    ...
    case "initialize": {
      ["config"].forEach((prop) => {
        if (directive.args[prop] !== void 0) {
          ...
          directive.args[type22] = directive.args[prop];
...
function extractFrontMatter(text2, db, setDiagramConfig) {
  var _a, _b;
  ...
  if (parsed == null ? void 0 : parsed.title) {
    (_a = db.setDiagramTitle) == null ? void 0 : _a.call(db, parsed.title.toString());
  }
  if (parsed == null ? void 0 : parsed.displayMode) {
    (_b = db.setDisplayMode) == null ? void 0 : _b.call(db, parsed.displayMode.toString());
  }
...
var Diagram = class {
  constructor(text2) {
    ...
    this.parser.parse = (text22) => originalParse(cleanupComments(extractFrontMatter(text22, this.db, addDirective)));
...
mermaid/dist/mermaid-768dc893.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ENWLQLJT.js.map
